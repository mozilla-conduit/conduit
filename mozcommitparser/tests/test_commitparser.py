...
from mozcommitparser.commitparser import (
    add_hyperlinks,
    parse_backouts,
    parse_bugs,
    parse_commit_id,
...
class TestAddHyperlinks(unittest.TestCase):
    def test_link_source_repo(self):
        ...
        self.assertEqual(add_hyperlinks(
            'Source-Repo: https://example.com?bad&escape=%20\n'),
            'Source-Repo: <a href="https://example.com?bad&amp;escape=%20">https://example.com?bad&amp;escape=%20</a>\n')
    ...
    def test_link_revision(self):
        ...
        self.assertEqual(add_hyperlinks(
            ...
            'Source-Repo: <a href="https://github.com/mozilla/foo">https://github.com/mozilla/foo</a>\n'
            'Source-Revision: <a href="https://github.com/mozilla/foo/commit/abcdef">abcdef</a>\n')

        # Non-GitHub revision isn't linked.
        self.assertEqual(add_hyperlinks(
            'summary\n\n'
            'Source-Repo: https://example.com/foo\n'
            'Source-Revision: abcdef\n'),
            'summary\n\n'
            'Source-Repo: <a href="https://example.com/foo">https://example.com/foo</a>\n'
            'Source-Revision: abcdef\n')

        # Bad characters in revision string are escaped.
        self.assertEqual(add_hyperlinks(
            'Source-Repo: https://github.com/mozilla/foo\n'
            'Source-Revision: a?b&c=%20\n'),
            'Source-Repo: <a href="https://github.com/mozilla/foo">https://github.com/mozilla/foo</a>\n'
            'Source-Revision: <a href="https://github.com/mozilla/foo/commit/a?b&amp;c=%20">a?b&amp;c=%20</a>\n')
    ...
    def test_link_github_issues(self):
        ...
        self.assertEqual(add_hyperlinks(
            'Merge #5\n\n'
            'Source-Repo: https://github.com/mozilla/foo\n'),
            'Merge <a href="https://github.com/mozilla/foo/issues/5">#5</a>\n\n'
            'Source-Repo: <a href="https://github.com/mozilla/foo">https://github.com/mozilla/foo</a>\n')
        ...
        self.assertEqual(add_hyperlinks(
            ...
            'Related to PR #1321\n\n'
            'Source-Repo: https://github.com/mozilla/foo\n'),
            'Fix <a href="https://github.com/mozilla/foo/issues/34252">#34252</a>\n\n'
            'Related to PR <a href="https://github.com/mozilla/foo/issues/1321">#1321</a>\n\n'
            'Source-Repo: <a href="https://github.com/mozilla/foo">https://github.com/mozilla/foo</a>\n')
    ...
    def test_link_bugzilla(self):
        ...
        self.assertEqual(add_hyperlinks(
            ' 1234567\nfoo\n'),
            ' <a href="https://bugzilla.mozilla.org/show_bug.cgi?id=1234567">1234567</a>\nfoo\n')
        self.assertEqual(add_hyperlinks(
            'bug 1\n'),
            '<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=1">bug 1</a>\n')
        self.assertEqual(add_hyperlinks(
            'bug 123456\n'),
        ...
        self.assertEqual(add_hyperlinks(
            'foo #123456\n'),
            'foo #<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=123456">123456</a>\n')

        # When GitHub is in play, bare numbers are not hyperlinked and #\d is
        # for GitHub issues.

        self.assertEqual(add_hyperlinks(
            'Bug 123456 - Fix all of the things\n\n'
            'Source-Repo: https://github.com/mozilla/foo\n'),
            '<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=123456">Bug 123456</a> - Fix all of the things\n\n'
            'Source-Repo: <a href="https://github.com/mozilla/foo">https://github.com/mozilla/foo</a>\n')
        ...
        self.assertEqual(add_hyperlinks(
            ...
            'Source-Repo: https://github.com/mozilla/foo\n'),
            'Merge <a href="https://github.com/mozilla/foo/issues/4256">#4256</a>\n\n'
            'This fixes <a href="https://github.com/mozilla/foo/issues/9000">#9000</a> and '
            '<a href="https://bugzilla.mozilla.org/show_bug.cgi?id=324521">bug 324521</a>\n\n'
            'Source-Repo: <a href="https://github.com/mozilla/foo">https://github.com/mozilla/foo</a>\n')
